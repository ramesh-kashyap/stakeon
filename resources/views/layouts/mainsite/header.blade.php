							...
							<div class="col-lg-9 col-md-7 col-5">
								<div class="header-nav">
									<div class="header-menu d-none d-lg-flex flex-column flex-lg-row">
										<a class="header-menu__item border-0" href="/">
											<span>
										...
										<a class="header-menu__item" href="/faq">
											<span>
										...
										<a class="header-menu__item" href="/term-candition">
											<span>
										...
										<a class="header-menu__item mr-4" href="/contact-us">
											<span>
